    ...
    <div className="destination">
      ...
      <Tab titles={tabTitles}>
        <Panel>
          ...
          <hr />
          <p className="distance">AVG. DISTANCE <br /><span>384,400 km</span> </p>
          <p className="travel-time">Est. travel time <br /><span>3 days</span> </p>
        </Panel>
        <Panel>
          <h1>MARS</h1>
          ...
          <hr />
          <p className="distance">AVG. DISTANCE <br /><span>225 MIL. km</span> </p>
          <p className="travel-time">Est. travel time <br /><span>9 months</span> </p>
        </Panel>
        <Panel>
          <h1>EUROPA</h1>
          ...
          <hr />
          <p className="distance">AVG. DISTANCE <br /><span>628 MIL. km</span> </p>
          <p className="travel-time">Est. travel time <br /><span>3 years</span> </p>
        </Panel>
        <Panel>
          <h1>TITAN</h1>
          ...
          <hr />
          <p className="distance">AVG. DISTANCE <br /><span>1.6 BIL. km</span> </p>
          <p className="travel-time">Est. travel time <br /><span>7 years</span> </p>
        </Panel>
      </Tab>
    </div>
  );
